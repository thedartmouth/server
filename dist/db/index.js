...
const query = async (text, params) => {
  ...
  const res = await pool.query(text, params); // const duration = Date.now() - start
...
const getClient = async () => {
  ...
  const release = client.release; // set a timeout of 5 seconds, after which we will log this client's last query
